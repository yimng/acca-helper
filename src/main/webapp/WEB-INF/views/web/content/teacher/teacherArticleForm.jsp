...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/article/list?type=4">ACCA名师指导</a></li>
		<li class="active"><a href="${ctx}/article/form?type=4&articleId=${webArticle.articleId}">文章<shiro:hasPermission name="article:webArticle:edit">${not empty webArticle.articleId?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="article:webArticle:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="webArticle" action="${ctx}/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">老师<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="controls">
				<form:select path="teacherId" htmlEscape="false" maxlength="200" class="input-medium">
					<form:options items="${teacherList}" itemLabel="chName" itemValue="teacherId" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">老师职务<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="controls">
