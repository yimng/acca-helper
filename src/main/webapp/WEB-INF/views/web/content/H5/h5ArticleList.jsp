...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/article/list?type=4">专题管理</a></li>
		<shiro:hasPermission name="article:webArticle:edit"><li><a href="${ctx}/article/form?type=5">文章添加</a></li></shiro:hasPermission>
	</ul>
