...
public class AppAccaUserController extends BaseController {
    ...
    public @ResponseBody
    BaseObjResponse<String> getTestVcode(@RequestBody GetSmsVcodeReq req) {
    ...
    public @ResponseBody
    BaseResponse getSmsVcode(@RequestBody GetSmsVcodeReq req) {
    ...
    public @ResponseBody
    BaseResponse verifySmsVcode(@RequestBody LoginReq req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> login(@RequestBody LoginReq req) {
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> register(@RequestBody LoginWithPasswordReq req) {
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> loginWithPassword(@RequestBody LoginWithPasswordReq req) {
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> getUserInfo(@RequestBody BaseRequest req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse<>(req.isCorrectParams());
        }
    ...
    public @ResponseBody
    BaseObjResponse<Boolean> getUserPassword(@RequestBody BaseRequest req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse<>(req.isCorrectParams());
        }
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> updateUserInfo(@RequestBody UpdateUserInfoReq req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse<>(req.isCorrectParams());
        }
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> updateUserPassword(@RequestBody UpdateUserPasswordReq req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse<>(req.isCorrectParams());
        }
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> resetUserPassword(@RequestBody ResetUserPasswordReq req) {
    ...
    public @ResponseBody
    BaseObjResponse<AppAccaUser> updateUserPhone(@RequestBody UpdateUserPhoneReq req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse<AppAccaUser>(req.isCorrectParams());
        }
    ...
    public @ResponseBody
    BasePageResponse<AppAccaClub> getAccaClubList(@RequestBody BaseRequest req) {
    ...
    public @ResponseBody
    BaseResponse updateUserLocation(@RequestBody UpdateUserLocationReq req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse<AppAccaUser>(req.isCorrectParams());
        }
    ...
    @ApiOperation(value = "反馈分类列表", httpMethod = "POST", notes = "反馈分类列表")
    @RequestMapping(value = "getFeedbackCategory.do", method = RequestMethod.POST)
    public @ResponseBody
    BaseObjResponse getFeedbackCategory(@RequestBody BaseRequest req) {
        int resp = req.isCorrectParams();
        if (resp != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse(resp);
        }
        List<FbCategory> list = fbCateGoryService.findAllList();
    ...
    public @ResponseBody
    BaseResponse feedback(@RequestBody FeedbackReq req) {
        if (req.isCorrectParams() != RespConstants.GLOBAL_SUCCESS) {
            return new BaseObjResponse<AppAccaUser>(req.isCorrectParams());
        }
    ...
    public @ResponseBody
    BaseObjResponse<AppApkVersion> getApkUpdateInfo(@RequestBody BaseRequest req) {
    ...
    public @ResponseBody
    BaseObjResponse<AccaConfInfo> getAccaConfigInfo(@RequestBody BaseRequest req) {
    ...
    public @ResponseBody
    BasePageResponse<AppArticleCollectDto> getCollectArticleList(@RequestBody BasePageRequest req) {
    ...
    public @ResponseBody
    BaseResponse deleteCollectBatch(@RequestBody DeleteCollectBatchReq req) {
        int resp = req.isCorrectParams();
        if (resp != RespConstants.GLOBAL_SUCCESS) {
            return new BasePageResponse<AppArticleCollectDto>(resp);
        }
    ...
    @CrossOrigin
    public @ResponseBody
    BaseResponse invite(@RequestBody InviteReq req) {
    ...
    @CrossOrigin
    public @ResponseBody
    BasePageResponse<Invite> getInvitesByStatus(@RequestBody InviteStatusReq req) {
        int resp = req.isCorrectParams();
        if (resp != RespConstants.GLOBAL_SUCCESS) {
    ...
    @CrossOrigin
    public @ResponseBody
    BasePageResponse<InviteReward> getInviteRewardsRank(@RequestBody BasePageRequest req) {
        int resp = req.isCorrectParams();
        if (resp != RespConstants.GLOBAL_SUCCESS) {
            return new BasePageResponse(resp);
        }
