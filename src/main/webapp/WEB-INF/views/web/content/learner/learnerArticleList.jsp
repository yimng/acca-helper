...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/article/list?type=3">学习达人分享</a></li>
		<shiro:hasPermission name="article:webArticle:edit"><li><a href="${ctx}/article/form?type=3">文章添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="coupon">
			<tr>
				...
				<shiro:hasPermission name="article:webArticle:edit"><td>
    				...
    				<a href="${ctx}/article/form?type=3&articleId=${coupon.articleId}">编辑</a>
					<a href="${ctx}/article/delete?type=3&articleId=${coupon.articleId}" onclick="return confirmx('确认要删除该文章吗？', this.href)">删除</a>
