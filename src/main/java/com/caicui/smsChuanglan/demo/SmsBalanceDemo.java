...
import com.caicui.smsChuanglan.request.SmsBalanceRequest;
import com.caicui.smsChuanglan.response.SmsBalanceResponse;
...
//        String requestJson = JSON.toJSONString(smsBalanceRequest);
        String requestJson = JsonUtil.toJson(smsBalanceRequest);
        ...
        SmsBalanceResponse smsVarableResponse = //JSON.parseObject(response, SmsBalanceResponse.class);
                JsonUtil.toObject(response, SmsBalanceResponse.class);
