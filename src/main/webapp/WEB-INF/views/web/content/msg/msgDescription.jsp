...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sysmsg/webMsgSys/">系统推送</a></li>
		<li class="active"><a href="${ctx}/sysmsg/webMsgSys/form?msgId=${webMsgSys.msgId}">查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="webMsgSys" action="${ctx}/sysmsg/webMsgSys/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="msgTitle" disabled="true" htmlEscape="false" maxlength="256" class="input-xlarge required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">内容<font color="red">*</font></label>
			<div class="controls">
				<form:textarea path="msgContent" disabled="true" htmlEscape="false" rows="4" class="input-xxlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="pushPeople" disabled="true" items="${fns:getDictList('push_people_type')}" onclick="showContent(value);" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="jumpType" disabled="true" items="${fns:getDictList('msg_open_type')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div id="course-content" style="display: none;">
			<div class="control-group">
				<label class="control-label">文章<font color="red">*</font></label>
				<div class="controls">
					<select disabled="disabled" id="articleId" name="articleId" class="input-medium"></select>
					<span class="help-inline"> </span>
				</div>
			</div>
		</div>
