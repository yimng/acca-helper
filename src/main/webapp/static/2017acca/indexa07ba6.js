...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2ae182436879cd0e667ea44be42bd8e9.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "b12fee1435dac9320153a916678aadbc.png";
	...
	var Turntable = function () {
	  ...
	  _createClass(Turntable, [{
	    ...
	    value: function getUserAwardNum() {
	      ...
	      $.ajax({
	        url: '/acca/api/article/getUserAwardNum.do',
	        type: "POST",
	        async: true,
	        data: {
	          phone: $.cookie('phone')
	    ...
	    value: function listRoll() {
	      ...
	      if (s.isFakeData) {
	        ...
	        $.ajax({
	          url: '/acca/api/article/getAwardList.do',
	          type: "POST",
	          data: {},
	          success: function success(res, status, xhr) {
	    ...
	    value: function bindEvent() {
	      ...
	      $getCode.on('click', function () {
	        ...
	        $.ajax({
	          url: '/acca/api/article/getVcode.do',
	          type: "POST",
	          data: {
	            phone: _phoneVal
	          },
	      ...
	      $startCJ.on('click', function () {
	        ...
	        $.ajax({
	          url: '/acca/api/article/chekUser.do',
	          type: "POST",
	          data: {
	            phone: _phoneVal,
	            smsVcode: _codeVal
	      ...
	      for (i = 0, len = this.list.children.length; i < len; i++) {
	        ...
	        this.list.children[i].addEventListener('click', function () {
	          ...
	          $.ajax({
	            url: '/acca/api/article/getCaicuiAward.do',
	            type: "POST",
	            data: {
	              phone: $.cookie('phone'),
	      ...
	      $onTargetList.on('click', function () {
	        ...
	        $.ajax({
	          url: '/acca/api/article/getUserAwardList.do',
	          type: "POST",
	          data: {
	            phone: $.cookie('phone')
	          },
	    ...
	    value: function userIsAward() {
	      ...
	      // 中什么奖
	      $.ajax({
	        url: '/acca/api/article/getAward.do',
	        type: "POST",
	        data: {
	          phone: $.cookie('phone')
	        },
...
/***/ }
/******/ ]);
//# sourceMappingURL=indexa07ba6.js.map