...
/***/ function(module, exports, __webpack_require__) {
	...
	var globalScrollTip = function globalScrollTip() {
	  ...
	  for (i = 0, len = defaultData.length; i < len; i++) {
	    html += '<li>' + defaultData[i].phone + '&nbsp;' + defaultData[i].time + '&nbsp;' + defaultData[i].text + '&nbsp;' + defaultData[i].surplus + '</li>';
	  }
	  ...
	  function scrollUl() {
	    ...
	    timer = setTimeout(function () {
	      ...
	      if (Math.floor(num) == wrapHeight * len) {
	...
	window.onload = function () {
	  ...
	  var homeBuilding = DOC.querySelector('#homeBuilding');
	  ...
	  setTimeout(function () {
	    ...
	    for (i = 0, len = homeBuilding.children.length; i < len; i++) {
	      ...
	      var _obj = homeBuilding.children[i];
