...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/article/list?type=3">学习达人分享</a></li>
		<li class="active"><a href="${ctx}/article/form?type=3&articleId=${webArticle.articleId}">文章<shiro:hasPermission name="article:webArticle:edit">${not empty webArticle.articleId?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="article:webArticle:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="webArticle" action="${ctx}/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">学习达人<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="controls">
				<form:select path="learnShareUserId" htmlEscape="false" maxlength="400" class="input-medium required">
					<form:option value="" label="请选择"/>
					<form:options items="${learnShareUserList}" itemLabel="showName" itemValue="accaUserId" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">设置<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="controls">
