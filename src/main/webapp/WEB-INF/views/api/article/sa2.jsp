...
<head>
	...
	<script type="text/javascript">
		...
		<c:if test="${accauser.accaUserId==null}">
			...
			//$("#intro_").focus();	
				alert("请进入ACCA小助手app登陆后再进行学员认证。");
		</c:if>	
		<c:if test="${accauser.accaUserId!=null}">
			accaUserId=${accauser.accaUserId};
			if(accaUserId == null || accaUserId == "" || accaUserId == "undefined"){
				alert("请在ACCA小助手中并进行登录再进行操作");
			}
			//$("intro_form").classList.remove('hid');
			$("#btn-submit").click(function() {
				...
				if(window.confirm("您确定要提交学员认证信息吗？")){
					$.ajax({
			...
			<c:if test="${accauser.cityId!=null}">
				$("#cityId").val("${accauser.cityId}");
				$("#cityId_cover").html("${accauser.cityId}");
			</c:if>
		</c:if>			
		});
	...
	<meta name="wxm:timeline_title" content="中博&amp;财萃网学员认证">
	<meta name="wxm:appmessage_title" content="中博&amp;财萃网学员认证">
...
<div id="container" style="height:100%;">
    ...
    <div class="intro" style="padding-top: 0px;">
        ...
        <div class="intro__below intro__below_form">
            ...
            <div id="intro_form" class="intro__form">
                ...
                <div class="intro__form-region" id="cityId_div">
                    <div class="intro__select-cover" id="cityId_cover">距离最近的分部</div>
