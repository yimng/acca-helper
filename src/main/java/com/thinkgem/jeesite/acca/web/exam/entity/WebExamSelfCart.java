 ...
 * @version 2016-08-17
 */
public class WebExamSelfCart extends DataEntity<WebExamSelfCart> {
	...
	public WebExamSelfCart() {
		super();
	}

	public WebExamSelfCart(String id) {
		super(id);
	}
	...
	public AppExamVersion getExamVersion() {
		this.examVersion = JsonMapper.getInstance().fromJson(
				this.examVersionJson, AppExamVersion.class);
		return examVersion;
	}
	...
	public String getShowExamTimeStr() {
		String startTimeStr = DateTimeUtils.convertDate2String(
				this.examStartTime, "yyyy-MM-dd HH:mm");
		String endTimeStr = DateTimeUtils.convertDate2String(this.examEndTime,
				"-HH:mm");
