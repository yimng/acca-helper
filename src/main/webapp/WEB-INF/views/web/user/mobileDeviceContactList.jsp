...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/user/mobileDeviceContact/">查看</a></li>
		<%-- <shiro:hasPermission name="common:mobileDeviceContact:edit"><li><a href="${ctx}/common/mobileDeviceContact/form">AppMobileDeviceContact添加</a></li></shiro:hasPermission> --%>
	</ul>
