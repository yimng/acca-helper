				...
				<div style="position: relative;">
					<div class="span12" style="margin-top:-10px;margin-bottom: 10px">
						<div class="span2" style="border-radius:50%;overflow:hidden;">
							...
							<c:if test="${article.learningUser.headImg!=null}">
								<c:if test="${article.learningUser.headImg.fileUrl!=null}">
									<img alt="" src="${article.learningUser.headImg.fileUrl}" style="width:100%" />	
								</c:if>
								<c:if test="${article.learningUser.headImg.fileUrl==null}">
						...
						<div class="span10"  style="margin-top:18px">
							<div style="font-size:15px;color:#7b80a5" >${article.learningUser.nickname} <img style="margin-top:-5px;margin-left:14px;width:20%" alt="" src="${ctxStatic}/images/article_learning.png" /></div>
						</div>
					</div>
